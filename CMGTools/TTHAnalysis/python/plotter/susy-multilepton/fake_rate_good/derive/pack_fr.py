...
if __name__ == "__main__":
    ...
    os.mkdir(NEWDIR)
    for ob in ["Mu"]:
        assemble2D("FR_FO9_%s" % (ob,),"%s/%s_FO9%s/susy_2lss_fake_rate_good_study.root" % (PLOTSPATH,PLOTSPREFIX,ob),"reg_eta_mypt_allaway_background","reg_eta_mypt_tightaway_background")
