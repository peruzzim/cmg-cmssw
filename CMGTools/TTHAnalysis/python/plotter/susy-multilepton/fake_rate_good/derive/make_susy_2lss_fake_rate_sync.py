...
PATH="-P /data1/p/peruzzi/TREES_72X_070615_MiniIso -F sf/t {P}/3_QCDVarsSusy_FakeRateFO_v10/evVarFriend_{cname}.root %s --mcc susy-multilepton/fake_rate_good/susy_2lss_fake_rate_customchoices.txt "
FTREEQCD=""
...
runs.append(["FO9Mu","susy-multilepton/fake_rate_good/derive/susy_2lss_fake_rate_perlep.txt",TightMuSel+QCDmeasReg+["ABCregion"],["sipLT4"],[("multiiso","minireliso04")],MuDsetsQCD])
...
if doplot:
    for run in runs:
        ...
        B0=' '.join(['echo',run[0],';',RUN,MYPATH,"susy-multilepton/fake_rate_good/susy_2lss_fake_rate_mca_sync.txt",run[1],"susy-multilepton/fake_rate_good/derive/susy_2lss_fake_rate_good_study.txt"])
