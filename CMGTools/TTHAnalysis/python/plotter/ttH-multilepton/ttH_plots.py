...
def base(selection='2lss'):
    ...
    if selection=='2lss':
        GO="python mcPlots.py %s ttH-multilepton/mca-2lss-Mor16.txt ttH-multilepton/2lss_Mor16.txt -f -j 8 --lspam '#bf{CMS} #it{Preliminary}' --legendWidth 0.20 --legendFontSize 0.035 --showRatio --maxRatioRange 0 3 ttH-multilepton/check_FO_def_plots.txt --showMCError"%CORE
#    elif selection=='3l':
...
#        runIt(x2,'2lss_SR_nojetcut_%s'%mod)
    ...
    x = base('2lss')
    x = x.replace('mca-2lss-Mor16.txt','mca-2lss-Mor16-appl.txt')
