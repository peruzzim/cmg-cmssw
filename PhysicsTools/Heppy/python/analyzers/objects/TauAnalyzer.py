...
class TauAnalyzer( Analyzer ):
    ...
    def makeTaus(self, event):
        ...
        for tau in alltaus:
            ...
            tau.idMVAOldDMRun2 = id5(tau, "by%sIsolationMVArun2v1DBoldDMwLT", mayFail=True)
            tau.idMVAOldDMRun2dR03 = id4(tau, "by%sIsolationMVArun2v1DBdR03oldDMwLT", mayFail=True)
